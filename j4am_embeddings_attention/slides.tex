  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \begin{alertblock}{Le problème de la softmax}
        \vspace{-2pt}
        \[
          P(w \mid c) = \frac{e^{u_w \cdot v_c}}{\displaystyle\sum_{i=1}^{V} e^{u_i \cdot v_c}}
        \]
        \vspace{-4pt}
      ...
      \begin{block}{Solution}
        ...
        \begin{itemize}
          ...
          \item maximiser $\sigma(u_{w^+} \cdot v_c)$
          \item minimiser $\sigma(u_{w_i^-} \cdot v_c)$
        \end{itemize}
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \begin{block}{Idée centrale}
        ...
        \]
        Objectif : apprendre $u_i, v_j$ tels que :
        \[
          u_i \cdot v_j + b_i + b_j \;\approx\; \log X_{ij}
        \]
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \begin{block}{Encodage sinusoïdal (Vaswani 2017)}
        ...
        \end{align*}
        \normalsize
        On \textbf{additionne} à l'embedding : $x_t \leftarrow x_t + PE_t$
      \end{block}
    \end{column}
    \begin{column}{0.44\textwidth}
