...
\begin{frame}[fragile]{Software Design : La Dataclasse \texttt{Value}}
  \begin{columns}[T]
    \begin{column}{0.34\textwidth}
      ...
      \end{block}
      \smallskip
      \begin{exampleblock}{\texttt{eq=False}}
        \small Conserve le hash par \textbf{identité} --- deux nœuds avec la même valeur restent distincts dans le graphe
      \end{exampleblock}
    \end{column}
...
\begin{frame}[fragile]{Style Fonctionnel : Opérateurs comme Factories}
  \begin{columns}[T]
    \begin{column}{0.34\textwidth}
